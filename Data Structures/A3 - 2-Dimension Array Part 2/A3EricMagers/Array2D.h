...
*			to 0 if client does not pass it as an argument. Array's first
*			dimension is set to row and the second is set to col
*	Array2D (const Array2D &copy)
*		Initializes the Array2D object to the same size row and column size
*			as the copy object, then copies the array into the new object.
*	~Array2D ( )
*		Deletes the Array2D object
*	operator = (const Array2D &rhs)
*		Copies rhs into the specified Array2D object after copying the 
...
*		Returns the value stored in the value stored in the pointer at the
*			index indicated by row and column
*************************************************************************/
template<typename T>
class Array2D
{
